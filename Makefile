...
windows:
	...
	CGO_ENABLED=0 GOARCH=amd64 GOOS=windows go build -o dist/windows/amd64/newsocks.exe
	CGO_ENABLED=0 GOARCH=386 GOOS=windows go build -o dist/windows/386/newsocks.exe
